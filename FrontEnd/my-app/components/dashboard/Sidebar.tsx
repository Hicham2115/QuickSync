...
export function Sidebar() {
  ...
  return (
    <aside
      ...
      style={{ background: "#131B2C" }}
    >
      {/* Logo */}
      <div
        className="h-16 flex items-center px-5 gap-2.5"
      ...
      >
        ...
        <span
          className="font-display text-[17px] font-medium text-white"
            ...
            {group.items.map(({ icon: Icon, label, href }) => {
              ...
              return (
                <Link
                  ...
                  style={{
                    background: active ? "rgba(255,255,255,.1)" : undefined,
                  }}
                  onMouseEnter={(e) => {
                    if (!active)
      ...
      >
        {menuOpen && (
          ...
          >
            ...
            <button
              ...
              style={{ color: "#B4453A" }}
              onMouseEnter={(e) => {
                e.currentTarget.style.background = "rgba(180,69,58,.1)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.background = "transparent";
              }}
        ...
        >
          ...
          <div className="flex-1 min-w-0 text-left">
            <p className="font-sans text-[13px] font-semibold text-white truncate">
              Fatima Zahra Alami
            </p>
            <p
